          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <Card>
              <CardContent>
                ...
                <Typography color="text.secondary">No recent forms</Typography>
              </CardContent>
            </Card>
          </Grid>
        </Grid>
